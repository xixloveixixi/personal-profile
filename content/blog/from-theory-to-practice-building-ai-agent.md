...
## 第一部分：理解 Agent 的本质（Hello-Agents 第 1-2 章回顾）

> **对应教程章节**：第1章《智能体与语言模型基础》、第2章《智能体核心架构》
>
> **核心概念**：Agent 四要素、反应式/规划式/混合式架构、LLM 的局限性与 Agent 的突破
...
## 第二部分：ReAct 范式与工具调用（Hello-Agents 第 3-4 章实践）

> **对应教程章节**：第3章《智能体经典范式》、第4章《工具调用与外部交互》
>
> **核心概念**：ReAct 思考-行动循环、Function Calling、工具定义与封装、可靠性设计
